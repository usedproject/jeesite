...
<body>
	...
	<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="name" name="name" list="names" class="input-xlarge required" type="text" value="" maxlength="20">
				<datalist id="names">
				</datalist>
			</div>
		</div>	
		<div class="control-group">
			...
			<div class="controls">
				<input id="idcard" list="idcards" name="idcard" class="input-xlarge required" type="text" value="" maxlength="20">
				<datalist id="idcards">
				</datalist>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="paydate" name="paydate" class="input-xlarge required isDate" type="text" value="" maxlength="20">
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
