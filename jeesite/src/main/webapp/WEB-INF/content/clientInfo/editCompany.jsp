	...
	<!-- <script type="text/javascript">top.$.jBox.closeTip();</script> -->
		...
		<table class="table table-bordered table-condensed" width="800px">
			<tbody><tr>
				...
				<td>
					<input id="companyno" name="companyno" class="input-xlarge required creditcard" type="text" value="${company.companyno }" maxlength="20">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			</tr>
			<tr>
				<td><label class="control-label">电话：</label></td>
				<td><input id="telphone" name="telphone" class="input-xlarge required" type="text" value="${company.telphone }" maxlength="13">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
				<td><label class="control-label">邮编：</label></td>
				<td><input id="zipcode" name="zipcode" class="input-xlarge required isZipCode" type="text" value="${company.zipcode }" maxlength="20">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			</tr>
			...
			<tr>
				...
				<td><input id="owner" name="owner" class="input-xlarge required isName" type="text" value="${company.owner }" maxlength="30">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
				<td><label class="control-label">身份证号：</label></td>
				<td><input id="idcard" name="idcard" class="input-xlarge required isIdCard" type="text" value="${company.idcard }" maxlength="20">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			</tr>
			...
			<tr>
				...
				<td><input id="phone" name="phone" class="input-xlarge required isPhone" type="text" value="${company.phone }" maxlength="13">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			...
			<tr>
				...
				<td><input id="email" name="email" class="input-xlarge required email" type="text" value="${company.email }" maxlength="50">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			...
			<tr>
				...
				<td colspan="3"><textarea id="address" name="address" maxlength="256" class="input-xxlarge " rows="2" value="${company.address }"></textarea></td>
			</tr>
			
			<tr>
				<td><label class="control-label">备注：</label></td>
				<td colspan="3"><textarea id="remark" name="remark" maxlength="512" class="input-xxlarge " rows="2" value="${company.remark }"></textarea></td>
			</tr>
	...
	$(function(){
		  ...
		  $.post(
			...
			function(data){
				$.each(data,function(i,o){
					if(o.value==${company.status==null?0:company.status}){
		...
		/* 公司类别下拉框动态加载 */
		  $.post(
					...
					function(data){
						$.each(data,function(i,o){
							if(o.value=="${company.companytype==null?0:company.companytype}"){
								var content =$("<option value='"+o.value+"' selected='selected'>"+o.label+"</option>");
							}else{
								var content =$("<option value='"+o.value+"' >"+o.label+"</option>");
							}
