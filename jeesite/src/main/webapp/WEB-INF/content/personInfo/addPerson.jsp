	...
	<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
		...
		<table class="table table-bordered table-condensed">
			<tbody><tr>
				...
				<td>
					<input type="text" id="customerName" name="customerName" value="" list="names" class="input-xlarge required">
			...
			<tr>
				...
				<td>
					<select name="jobtype" tabindex="-1" >
			...
			<tr>
				...
				<td colspan="3">
					<input id="resumeurl" name="resume" maxlength="256" class="input-xlarge required" type="file" >
				</td>
			</tr>
<!-- <script type="text/javascript">
