...
<body>
	<div title="添加数据字典" data-options="closable:false" class="basic-info" style="margin-left: auto; margin-right: auto" align="center">
		<form id="ff">
...
<script type="text/javascript">
	...
	/* 提交的方法 */
	function add() {
		$.post("system/dict/addDict.do", $("#ff").serialize(), function(data){
			alert(data.message)
		}, "json")
	}
</script>
