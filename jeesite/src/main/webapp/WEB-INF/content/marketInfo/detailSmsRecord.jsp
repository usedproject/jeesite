...
<body>
	...
	<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
		<div class="control-group">
			...
			<div class="controls">
				<input id="username" name="username"  class="input-xlarge required " type="text" value="${smsRecord.userName }" maxlength="11">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">接收人电话：</label>
			<div class="controls">
				<input id="telephone" name="telephone" class="input-xlarge required" type="text" value="${smsRecord.telephone }" maxlength="512">
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea id="content" name="content" class="input-xxlarge required" rows="4">${smsRecord.content }</textarea>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
	</form>
