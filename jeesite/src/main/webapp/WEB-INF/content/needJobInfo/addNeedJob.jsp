	...
	<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
		...
		<table class="table table-bordered table-condensed">
			<tbody><tr>
				...
				<td>
					<input id="jobtype" name="jobtype" class="input-xlarge required" type="text" value="" maxlength="100">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input id="needperson" name="needperson" class="input-xlarge required number" type="text" value="" maxlength="11">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input id="price" name="price" class="input-xlarge required number" type="text" value="">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
				<td><label class="control-label">工作地点：</label></td>
				<td>
					<input id="address" name="address" class="input-xlarge required" type="text" value="" maxlength="2">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input name="starttime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required" value="" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-dd HH:mm:ss&#39;,isShowClear:false});">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
				<td><label class="control-label">结束日期：</label></td>
				<td>
					<input name="endtime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required" value="" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-dd HH:mm:ss&#39;,isShowClear:false});">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			</tr>
