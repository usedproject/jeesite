...
<script type="text/javascript">
	$(function() {
		/* 加载数据字典中的记录 */
		$("#tb").datagrid({
			url:'business/socialInsuranceRecord/getStatistics.do',
	        method:"post",
			toolbar:"#toolbar",
			...
			columns:[[
				...
				{field:"cpname", title:'所属公司'},
				{field:"counts", title:'社保月数'},
				{field:"sums", title:'社保总额'},
				{field:"proxyFee", title:'费用总额'},
	...
	function exportExcel() {
		var url = 'business/socialInsuranceRecord/export.do';
