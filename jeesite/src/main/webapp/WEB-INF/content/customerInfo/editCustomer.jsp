			...
			$(function(){
				  ...
				  $.post(
							...
							function(data){
								$.each(data.result,function(i,o){
									if(o.id==${customer.companyid==null?888888888888:customer.companyid}){
				...
				$("#inputForm").validate({
					submitHandler: function(form){
						$.post(
							"business/customer/editCustomer.do",
							$("#inputForm").serialize(),
							function(data){
								alert(data.message)
							},
	...
	<form id="inputForm" class="form-horizontal"  novalidate="novalidate">
		...
		<table class="table table-bordered table-condensed">
			<tbody><tr>
				...
				<td>
					<input id="name" name="name" class="input-xlarge required isName" type="text" value="${customer.name }" maxlength="20">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
				<td><label class="control-label">身份证号：</label></td>
				<td><input id="idcard" name="idcard" class="input-xlarge required isIdCard" type="text" value="${customer.idcard }" maxlength="20">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<input id="sex" name="sex" class="input-xlarge " type="radio" value="男" checked="checked">男
					<input id="sex" name="sex" class="input-xlarge " type="radio" value="女" >女
					</c:if>
					<c:if test="${customer.sex=='女' }">
					<input id="sex" name="sex" class="input-xlarge " type="radio" value="男" >男
					<input id="sex" name="sex" class="input-xlarge " type="radio" value="女" checked="checked">女
					</c:if>
					
				</td>
				<td><label class="control-label">出生年月：</label></td>
				<td>
					<input name="birthday" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required" value="<fmt:formatDate value='${customer.birthday }' pattern='yyyy-MM-dd HH:mm:ss' />" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-dd HH:mm:ss&#39;,isShowClear:false});">
				</td>
			</tr>
			<tr>
				<td><label class="control-label">手机号码：</label></td>
				<td>
					<input id="phone" name="phone" class="input-xlarge required isPhone" type="text" value="${customer.phone }" maxlength="13">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
				<td><label class="control-label">电子邮件：</label></td>
				<td><input id="email" name="email" class="input-xlarge required email" type="text" value="${customer.email }" maxlength="50">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			</tr>
			<tr>
				...
				<td><input id="zipcode" name="zipcode" class="input-xlarge isZipCode" type="text" value="${customer.zipcode }" maxlength="20"></td>
			</tr>
			...
			<tr>
				...
				<td><input name="graduation" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required" value="${customer.graduation }" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-dd HH:mm:ss&#39;,isShowClear:false});"></td>
			...
			<tr>
				...
				<td>
					<select id="customerType" name="customerType" value="${customer.customertype==null }" class="input-xlarge  select2-offscreen" tabindex="-1">
				...
				<td>
					<c:if test="${customer.issalary=='0' }">
						<input type="checkbox" checked="checked" name="issalary">
					</c:if>
					<c:if test="${customer.issalary!='0' }">
						<input type="checkbox"  name="issalary">
					</c:if>
				</td>
			</tr>
			 ...
			 <tr>
				...
				<td>
					<c:if test="${customer.isshebao=='0' }">
						<input type="checkbox" checked="checked" name="isshebao">
					</c:if>
					<c:if test="${customer.isshebao!='0' }">
						<input type="checkbox" name="isshebao">
					</c:if>
				</td>
				...
				<td>
					...
					<c:if test="${customer.isgongjijin=='0' }">
						<input type="checkbox" checked="checked" name="isgongjijin">
					</c:if>
					<c:if test="${customer.isgongjijin!='0' }">
			...
			<tr>
				...
				<td>
					<select name="status" value="${customer.status }" class="input-xlarge  select2-offscreen" tabindex="-1">
