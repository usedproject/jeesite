		...
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				submitHandler: function(form){
					...
					$.post(
						"system/function/add.do",
						$("#inputForm").serialize(),
						function(data){
							if(data.success){
								alert(data.message);
								window.location.href="company/system/function.do";
							}else{
...
<div class="input-append">
	...
	<input id="parent_Name"  readonly="readonly" type="text" value="" data-msg-required="" class="required" style="">
