...
<body>
	<div title="添加短信模板" data-options="closable:false" class="basic-info" style="margin-left: auto; margin-right: auto" align="center">
		<form id="ff">
...
<script type="text/javascript">
	$(function() {
		...
		$("#addBtn").on('click', function() {
			$.post("system/smsTemplate/addTemplate.do", $("#ff").serialize(), function(data){
				alert(data.message)
			}, "json")
		})
	})
