	...
	<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
		...
		<table class="table table-bordered table-condensed">
			<tbody><tr>
				...
				<td>
					<input type="text" id="name" name="name" list="names" value="" class="input-xlarge required">
				...
				<td>
					<input id="idcard" name="idcard" list="idcards" class="input-xlarge required" type="text" value="" maxlength="20">
					<span class="help-inline"><font color="red">*</font> </span>
					<datalist id="idcards">
			...
			<tr>
				...
				<td>
					<input id="companyprice" name="companyprice" class="input-xlarge required number" type="text" value="">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
				<td><label class="control-label">个人单价：</label></td>
				<td>
					<input id="personprice" name="personprice" class="input-xlarge required number" type="text" value="">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input name="starttime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required" value="" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-dd HH:mm:ss&#39;,isShowClear:false});" style="width:270px;">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
				<td><label class="control-label">结束时间：</label></td>
				<td>
					<input name="endtime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required" value="" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-dd HH:mm:ss&#39;,isShowClear:false});" style="width:270px;">
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input id="contracturl" name="contract"  class="input-xlarge required" type="file" >
					<span class="help-inline"><font color="red">*</font> </span>
				</td>
