            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
               <form id="editpasswordform">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input id="txtNewPass" required="true" type="Password" data-options="validType:'length[4,6]'" class="txt01 easyui-validatebox" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input id="txtRePass" required="true" data-options="validType:'equalTo[\'#txtNewPass\']'" type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                </table>
                </form>
            </div>
