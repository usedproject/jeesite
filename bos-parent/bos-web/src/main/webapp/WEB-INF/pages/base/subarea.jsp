...
<script type="text/javascript">
	...
	function doExport(){
		window.location.href="${pageContext.request.contextPath }/subAreaAction_exportSubArea.action";
	}
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath }/subAreaAction_listSubArea.action",
			idField : 'id',
			columns : columns,
    ...
    function doShowHigncharts(){
    	$("#showSubareaWindow").window("open");
		//页面加载完成后，动态创建图表
		$.post("${pageContext.request.contextPath }/subAreaAction_findSubareasGroupByProvince.action",function(data){
			$("#test").highcharts({
				chart: {
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="saveForm" action="${pageContext.request.contextPath }/subAreaAction_saveSubArea.action" method="post">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							...
    							textField:'name',
    							url:'${pageContext.request.contextPath }/regionAction_selectRegion.action',
    							mode:'remote'" />  
						</td>
					</tr>
					<tr>
