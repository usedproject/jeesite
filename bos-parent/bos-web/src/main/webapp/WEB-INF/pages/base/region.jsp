...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath }/regionAction_listRegion.action?date="+new Date(),
			idField : 'id',
			columns : columns,
		...
		$("#button-import").upload({
			name: 'uploadFile',
			action: '${pageContext.request.contextPath }/regionAction_upload.action?'+new Date()
		})
